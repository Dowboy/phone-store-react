  ...
  return (
    <nav>
      <div className="nav__container">
        <Link to="/" className="logo__align">
          <span className="logo__text">Seb</span>
          <img src={PhoneLogo} alt="" className="logo" />
        ...
        <div className="menu__backdrop">
          ...
          <ul className="menu__links">
            ...
            <li className="menu__list">
              <Link to="/phones" className="menu__link" onClick={closeMenu}>
                Phones
              </Link>
            </li>
            <li className="menu__list">
